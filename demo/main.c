...
void main(void)
{
    ...
    while (true)
    {
        ...
        if (!askUserYN("Хотите пройтись по возможностям библиотеки?"))
            break;
        cls;
        ...
        if (!inputError)
            redPrint("Вы ввели не целое число и сработала защита\n");
        else
            greenPrint("Вы правильно ввели целое число x = %d\n", x);
        ...
        if (!inputError)
            ...
            greenPrint("Вы правильно ввели вещественное число y = %.2f\n", y);
